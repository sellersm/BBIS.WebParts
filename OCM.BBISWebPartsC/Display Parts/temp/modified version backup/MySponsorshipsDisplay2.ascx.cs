...
namespace OCM.BBISWebParts
{
    public partial class MySponsorshipsDisplay2 : BBNCExtensions.Parts.CustomPartDisplayBase
    {
        ...
        private void bindSponsorships()
        {
            ...
            {
                cmd.SelectCommand.Parameters.AddWithValue("@Id", "354E31CD-CD89-4078-9689-95A4CCCF310B");  //"7599754F-48F1-4CF0-95C5-4650B78366A3");  // Why is this here?
            }
            ...
            try
            {
                ...
                else
                {
                    if (this.processPayment())
                    {
                        this.submitPayment();
                        this.resetForm();
                        this.lblMessage.Text = ((MySponsorshipsOptions2)this.Content.GetContent(typeof(MySponsorshipsOptions2))).ThankYouMessage;
