<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PartnerSponsorshipSearchGridDisplay.ascx.cs" Inherits="OCM.BBISWebParts.PartnerSponsorshipSearchGridDisplay" %>
