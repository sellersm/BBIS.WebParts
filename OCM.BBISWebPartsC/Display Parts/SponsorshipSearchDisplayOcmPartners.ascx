<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SponsorshipSearchDisplayOcmPartners.ascx.cs" 
    Inherits="OCM.BBISWebParts.SponsorshipSearchDisplayOcmPartners" %>
