<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SponsorshipPaymentFormDisplayOCM.ascx.cs" Inherits="OCM.BBISWebParts.SponsorshipPaymentFormDisplayOCM" %>
<style type="text/css">
    .Validation
    {
        color: Red;
                            ...
                            <ContentTemplate>
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span id="PC1689_ctl00_lblDayPhone" class="BBFieldCaption ChildSearchFieldCaption">Day Phone (XXX) XXX-XXXX</span>
                                                </td>
                                            <td class="style4">
                                        ...
                                        <tr>
                                            <td>
                                                <span id="PC1689_ctl00_lblEmail" class="BBFieldCaption ChildSearchFieldCaption">Email (xxx@xxxxx.com or .org)</span>
                                                </td>
                                            <td class="style4">
