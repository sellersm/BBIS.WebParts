<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SponsorshipPaymentPaymentFormDisplay.ascx.cs"
    Inherits="OCM.BBISWebParts.SponsorshipPaymentPaymentFormDisplay" %>
...
<p><asp:Label ID="lblError" runat="server" ForeColor="Red" Visible="false" /></p>
                                    ...
                                    <ContentTemplate>
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblMI" class="BBFieldCaption ChildSearchFieldCaption">
                                                        Middle Initial</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblLastName" class="BBFieldCaption ChildSearchFieldCaption">
                                                        Last Name *</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblCountry" class="BBFieldCaption ChildSearchFieldCaption">
                                                        Country *</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblAddress2" class="BBFieldCaption ChildSearchFieldCaption">
                                                        Address 2</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span id="PC1689_ctl00_lblZip" class="BBFieldCaption ChildSearchFieldCaption">
                                                        Zip *</span>
                                                    </td>
                                                    <td class="style4">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        Email *</span></td>
                                                    <td class="style4"><asp:TextBox ID="txtEmail" runat="server" Width="200px"></asp:TextBox>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <table id="tblCC">
                                <tr>
                                    <td><strong>Credit Card Information
                                    </strong>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="reqCcName" runat="server" ControlToValidate="txtCcName"
                                                        Text="*" ErrorMessage="Credit Card Name" ForeColor="Red" ValidationGroup="Checkout" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="style1" colspan="2">
