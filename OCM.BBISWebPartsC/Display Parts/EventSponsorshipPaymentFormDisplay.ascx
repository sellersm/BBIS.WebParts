<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EventSponsorshipPaymentFormDisplay.ascx.cs" Inherits="OCM.BBISWebParts.EventSponsorshipPaymentFormDisplay" %>
<style type="text/css">
    .Validation
    {
        color: Red;
