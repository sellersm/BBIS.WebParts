...
{
    public partial class SponsorshipSearchDisplayOCM : BBNCExtensions.Parts.CustomPartDisplayBase
    {
        ...
        {
            int CurrentCount = this.bindSearchResults(true);
            this.currentPage = (CurrentCount / MyContent.ResultsPerPage);
            if ((CurrentCount % MyContent.ResultsPerPage) == 0)
            {
                this.currentPage--;
            }
