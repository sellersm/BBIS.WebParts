<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SponsorshipSearchEditOCMPartners.ascx.cs" Inherits="OCM.BBISWebParts.SponsorshipSearchEditOCMPartners" %>
