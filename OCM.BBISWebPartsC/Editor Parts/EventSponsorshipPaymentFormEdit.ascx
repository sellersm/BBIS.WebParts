<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EventSponsorshipPaymentFormEdit.ascx.cs" Inherits="OCM.BBISWebParts.EventSponsorshipPaymentFormEdit" %>
    ...
    <tr>
        <td>
            ...
            <table>
				...
				<tr>
					<td>
						<asp:Label ID="lblPaymentConfirmationEmail" Text="Design your payment confirmation email:" runat="server"></asp:Label>
					</td>
				 </tr>
				 <tr>
                    <td colspan="2">
                        <uc:HTMLEditor id="htmledPaymentConfirmationEmail" runat="server" oninit="htmled2PaymentConfirmationEmail_Init" />
                    </td>
                </tr>
