<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SponsorshipPaymentPaymentFormEdit.ascx.cs"
    Inherits="OCM.BBISWebParts.SponsorshipPaymentPaymentFormEdit" %>
